...
import { FlatList, ScrollView, View, ViewStyle, StyleSheet, Pressable, TouchableOpacity, Text } from "react-native"
...
// Define the slot type based on your backend
...
export default (props: Props) => {
    ...
    const formatDateRange = (dateFrom: string, dateTo: string) => {
        ...
        // Check if months and years are the same to simplify the format
